<x-layouts.app :title="__('Actualizar Contador')" :subheading="__('Información personal')">
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mx-auto sm:px-6 lg:px-8">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-3">
                                        <flux:field>
                                            ...
                                            <flux:input name="name" id="name" type="text"
                                                autocomplete="given-name" value="{{ $counter->name ?? '' }}"
                                    ...
                                    <div class="sm:col-span-3">
                                        <flux:field>
                                            ...
                                            <flux:input name="last_name" id="last_name" type="text"
                                                autocomplete="family-name" value="{{ $counter->last_name ?? '' }}"
                                    ...
                                    <div class="sm:col-span-3">
                                        <flux:field>
                                            ...
                                            <flux:input name="email" id="email" type="email"
                                                autocomplete="email" value="{{ $counter->user->email ?? '' }}"
                                    ...
                                    <div class="sm:col-span-3">
                                        <flux:field>
                                            ...
                                            <flux:input name="rfc" id="rfc" type="text"
                                                autocomplete="address-level2" maxlength="13"
                                                value="{{ $counter->rfc ?? '' }}"
                                    ...
                                    <div class="sm:col-span-2">
                                        <flux:field>
                                            ...
                                            <flux:select name="regime_id" id="regime_id"
                                    ...
                                    <div class="sm:col-span-2">
                                        <flux:field>
                                            ...
                                            <flux:input name="birthdate" id="birthdate" type="date"
                                                min="1900-01-01" value="{{ $counter->birthdate ?? '' }}"
