                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="curp" id="curp" type="text"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="rfc" id="rfc" type="text"
                                        oninput="this.value = this.value.toUpperCase();" maxlength="13"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="nombre_comercial" id="nombre_comercial" type="text"
                                        oninput="this.value = this.value.toUpperCase();"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="phone" id="phone" type="phone" maxlength="10"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="phone2" id="phone2" type="text" maxlength="10"
                                        oninput="this.value = this.value.slice(0, 10);"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="street" id="street" type="text"
                                        oninput="this.value = this.value.toUpperCase();"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="col" id="col" type="text"
                                        oninput="this.value = this.value.toUpperCase();"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="localities" id="localities" type="text"
                                        oninput="this.value = this.value.toUpperCase();"
                            ...
                            <div class="sm:col-span-2">
                                <flux:field>
                                    ...
                                    <flux:input name="referer" id="referer" type="text"
                                        oninput="this.value = this.value.toUpperCase();"
