...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Inicia sesion con tu cuenta')" :description="__('Ingresa tu correo y contraseña para iniciar sesión')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <flux:input
            wire:model="email"
            :label="__('Direccion de correo electrónico')"
            type="email"
            required
            autofocus
            autocomplete="email"
